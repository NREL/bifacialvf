...
def simulate(TMYtoread, writefiletitle=None,  beta = 0, sazm = 180, C = 0.5, D = None,
    ...
    simulate_inner(TMY, meta, writefiletitle,  beta, sazm, C, D, 
                    rowType, transFactor, cellRows, PVfrontSurface, PVbackSurface,  albedo, 
                    tracking, backtrack, rtr,  max_angle, sam_header)
...
def simulate_inner(myTMY3, meta, writefiletitle=None,  beta = 0, sazm = 180, C = 0.5, D = None,
    ...
    Args:
        myTMY3 (pd.DataFrame): A pandas DataaFrame containing for each timestep columns:
                               DNI, DHI, it can also have DryBulb, Wspd, zenith, azimuth, elevation 
