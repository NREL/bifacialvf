...
def readKeeton():
    ''' Makes CombinedData.pickle' returns data3 (pickle)
    '''
...
def modelSilfabTrina(psm):
    ...
    def findCEC(moduletext):
        ...
        cec_modules = pvlib.pvsystem.retrieve_sam(path = r"D:\SAM\2017.9.5\libraries\CEC Modules.csv")
...
df = pd.read_csv(os.path.join(directory,'TeagueBifacial.csv'))
...
bonanza_TWC_data_file = os.path.join(r'C:\Users\Silvana\Documents\GitHub\bifacialvf\bifacialvf\bonanza','Bonanza_TWC.csv')
